...
export const metadata: Metadata = {
  ...
  description:
    "라곰 출장마사지 이용 가이드 허브. 처음 이용하는 분, 사전 준비, 좋은 업체 고르는 법, 예약 시 확인할 점, 방문 매너, 자주 생기는 오해까지 항목별로 정리했습니다.",
};
      ...
      <section className="space-y-5">
        ...
        <div className="rounded-2xl border border-brand-200 bg-brand-100 p-6 text-sm leading-relaxed text-white/85 sm:p-7">
          <p>
            ...
            라곰 출장마사지는 정직한 운영을 기본으로 하지만, 그 전에 이용자분이 안전한
            기준을 알고 선택하실 수 있도록 객관적인 정보를 정리하는 것이 더
            중요하다고 판단해 이 가이드를 만들었습니다.
          </p>
          <p className="mt-3">
            이 페이지의 내용은 라곰 출장마사지 이용 여부와 관계없이 출장마사지를
